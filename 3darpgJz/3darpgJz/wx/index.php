...
<script>
  ...
  function stopRecord($fun){
    if(!_recordReady){
      return;
    }
    wx.stopRecord({
        success: function (res) {
            var baselocalId = res.localId;


            wx.uploadVoice({
              localId: baselocalId, // 需要上传的音频的本地ID，由stopRecord接口获得
