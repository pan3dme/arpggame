module welfare {
    ...
    export class WelfareEvent extends BaseEvent {
        ...
        //每日充值
        public static CHG_REFILL: string = "CHG_REFILL";

        //显示抽奖面板
        public static SHOW_LOTTERY_EVENT: string = "SHOW_LOTTERY_EVENT";
        public static LOTTERY_INFO_EVENT: string = "LOTTERY_INFO_EVENT";
        public static LOTTERY_CHG_EVENT: string = "LOTTERY_CHG_EVENT";
    ...
    export class WelfareProcessor extends BaseProcessor {
                ...
                switch (i + 1) {
                    ...
                    case SharedDef.MODULE_WELFARE_EVERYDAY:
                        ...
                        for (var $key in $obj.data) {
                            var $idx: number = $obj.data[$key]["id"] - 1;
        ...
        private showLottery(): void {
            if (!this._lotteryPanel) {
                this._lotteryPanel = new LotteryPanel();
            }
            this._lotteryPanel.load(() => {
                //停止绘制前面的ui
                this._lotteryPanel.show();
                this._lotteryPanel.refeshLog(this._lotteryInfoAry);
            })
        ...
        private _lotteryInfoAry: Array<any> = new Array;
        public showLotteryInfo(data: any): void {
        ...
        public lotteryResult($byte: ByteArray): void {
        ...
        private rewardlist($byte: ByteArray): void {
            // var rewardStr: string = $byte.readUTF();
            // var costStr: string = $byte.readUTF();
            ...
            var vo: s2c_show_giftcode_reward_list = new s2c_show_giftcode_reward_list();
            s2c_show_giftcode_reward_list.read(vo, $byte);

            var list:Array<Array<number>> = new Array
        ...
        public getHanderMap(): Object {
            ...
            obj[Protocols.SMSG_LOTTERY_RECHARGE_RESULT] = ($byte: ByteArray) => { this.lotteryResult($byte) };
            obj[Protocols.SMSG_SHOW_GIFTCODE_REWARD_LIST] = ($byte: ByteArray) => { this.rewardlist($byte) };
            return obj;
        }
