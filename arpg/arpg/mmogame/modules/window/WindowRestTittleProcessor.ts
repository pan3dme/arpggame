module wintittle {
    ...
    export class WindowRestTittleEvent extends BaseEvent {
        ...
        public static LOCK_WINDOW_RES_TITTLE_PANEL: string = "LOCK_WINDOW_RES_TITTLE_PANEL";
        public static UNLOCK_WINDOW_RES_TITTLE_PANEL: string = "UNLOCK_WINDOW_RES_TITTLE_PANEL";
        public static REFRESH_WINDOW_RES_TITTLE_PANEL: string = "REFRESH_WINDOW_RES_TITTLE_PANEL";
