module rightui {
    ...
    export class RightUiPanel extends UIPanel {
        ...
        private loadConfigCom(): void {
            ...
            this.removeChild(this.a_change)
        ...
        public exitMap($e: InteractiveEvent): void {
            ...
            } else if(GuidData.map.tbMapVo.inst_sub_type == 20){//经验副本
        ...
        public show(): void {
            ...
            var bagShow:boolean = GuidData.map.showAreaById(AreaType.rightChange_6)
          //  this.renderSetVisibel([this._bottomRender, this._midRender, this._redPointRender, this._effRender], bagShow);
            var exitShow:boolean = GuidData.map.showAreaById(AreaType.sceneExit_30);
        ...
        public drawSysTemTip(): void {
            ...
            if (temp) {
                var syslevtab:tb.TB_system_base
                var idx:number
                if(temp.npc == 1){
