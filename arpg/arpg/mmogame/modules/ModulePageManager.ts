class ModulePageManager {
    ...
    public static lockResTitle(): void {
        var $evt: wintittle.WindowRestTittleEvent = new wintittle.WindowRestTittleEvent(wintittle.WindowRestTittleEvent.LOCK_WINDOW_RES_TITTLE_PANEL);
        ModuleEventManager.dispatchEvent($evt)
    }

    public static unlockResTitle(): void {
        var $evt: wintittle.WindowRestTittleEvent = new wintittle.WindowRestTittleEvent(wintittle.WindowRestTittleEvent.UNLOCK_WINDOW_RES_TITTLE_PANEL);
        ModuleEventManager.dispatchEvent($evt)
    }

    public static refreshResTitle(): void {
        var $evt: wintittle.WindowRestTittleEvent = new wintittle.WindowRestTittleEvent(wintittle.WindowRestTittleEvent.REFRESH_WINDOW_RES_TITTLE_PANEL);
        ModuleEventManager.dispatchEvent($evt)
    }
