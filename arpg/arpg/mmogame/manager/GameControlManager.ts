class GameControlManager {
    ...
    */
    ...
    private _systemOpenShow: msgtip.SystemOpenShow;
...
class TestSceneMemory {
    private static instance: TestSceneMemory;
    public static getInstance(): TestSceneMemory {
        if (!this.instance) {
