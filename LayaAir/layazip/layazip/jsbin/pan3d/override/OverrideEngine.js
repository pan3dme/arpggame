...
var OverrideEngine = /** @class */ (function (_super) {
    ...
    OverrideEngine.initConfig = function () {
        Engine.update = function () { OverrideEngine.update(); }; //更换update
        Engine.init = function ($caves) { OverrideEngine.init($caves); }; //更换引擎初始化
        Engine.resetSize = function (width, height) { OverrideEngine.resetSize(width, height); }; //更尺寸变化
    };
