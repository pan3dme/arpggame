module faction {
    ...
    export class FactionSkillPanel extends WindowUi {
        ...
        private _skillCost0: UICompenent;
        private _skillCost1: UICompenent;
        private costIcon0: UICompenent;
        private costIcon1: UICompenent;
        ...
        private drawSkill($data: any): void {
            ...
            var idx: number = 10000 * $data.id + $data.lev + 1;
            var tabObj: any = TableData.getInstance().getData(TableData.tb_faction_skill_lvup, idx);
            if (tabObj) {
                LabelTextFont.writeSingleLabel(this._baseUiAtlas, this._skillCost0.skinName,
                    ColorType.color4392ff + tabObj.cost[0][1], 16, TextAlign.CENTER);
                ...
                LabelTextFont.writeSingleLabel(this._baseUiAtlas, this._skillCost1.skinName,
                    ColorType.color4392ff + tabObj.cost[1][1], 16, TextAlign.CENTER);
