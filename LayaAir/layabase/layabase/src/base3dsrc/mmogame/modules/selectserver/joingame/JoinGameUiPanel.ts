module selectserver {
    ...
    export class JoinGameUiPanel extends UIPanel {
        ...
        private loadConfigCom(): void {
            ...
            this.resize();
            LoadManager.getInstance().load("tb_server_list.txt", LoadManager.XML_TYPE, ($str: string) => {
        ...
        private _curvo:ServerVo;
        public resetData() {
            this._curvo = SelectServerModel.getInstance().getCurVo();

            var statestr: string = SelectServerModel.getInstance().StateKey[this._curvo.state]
