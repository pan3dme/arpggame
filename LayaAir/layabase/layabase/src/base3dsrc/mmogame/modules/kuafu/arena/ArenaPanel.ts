module kuafu {
    ...
    export class ArenaPanel extends WindowUi {
        ...
        private _arena3V3Panel: Arena3V3Panel;
        ...
        public constructor() {
            ...
            this._arena3V3Panel = new Arena3V3Panel();
        ...
        private initUI(): void {
            ...
            var keyAry: Array<number> = [SharedDef.MODULE_ARENA_DOUJIANTAI, SharedDef.MODULE_ARENA_RANK, SharedDef.MODULE_ARENA_XIANMO]
            for (var i = 0; i < 3; i++) {
