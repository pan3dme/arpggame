module strengthgem {
    ...
    export class NewStrengUiPanel extends WindowUi {
        ...
        public drawPage() {
            ...
            var $nextobj: any = TableData.getInstance().getData(TableData.tb_equipdevelop_bonus, (this._type + 1) * 100 + ary[this._type] + 1);
            var prop: Array<Array<number>>
            if ($nextobj) {
                //未满级
                ...
                if ($value == SharedDef.MODULE_MIX_STRENGTH) {
                    ...
                    for (let i = 0; i < 10; i++) {
                        ...
                        for (let k = 0;  k < gemlevary.length; k++) {
                ...
                LabelTextFont.writeSingleLabel(this._baseRender.uiAtlas, this.MasterUIAry[3].skinName,ColorType.color802626 + StrengUtil.KeyNameByType[this._type ] + ":" + ary[this._type] + "级", 14, TextAlign.LEFT);
            }
        }
