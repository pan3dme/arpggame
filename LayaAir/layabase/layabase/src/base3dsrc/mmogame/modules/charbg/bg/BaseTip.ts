class BaseTip extends UIConatiner {
    ...
    protected _basebgRender: UIRenderComponent;
    ...
    protected _t_lev_lab: UICompenent;
        ...
        IconManager.getInstance().getIcon(geteqiconIconUrl(this._entryData.icon),
            ($img: any) => {
                ...
                if (this._entryData.type == 1) {//装备
                    UiDraw.cxtDrawImg(ctx, "A_JJ" + this._entryData.realmbreak_level, new Rectangle(4, 4, 41, 17), UIData.publicUi);
    ...
    protected initBase(): void {
        ...
        this.b_basebg.addEventListener(InteractiveEvent.Up, ($evt: InteractiveEvent) => {
