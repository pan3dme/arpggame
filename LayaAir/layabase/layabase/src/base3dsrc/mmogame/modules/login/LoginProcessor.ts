class LoginProcessor extends BaseProcessor {
    ...
    private _loginNewPanel: loginnew.LoginNewPanel;
    ...
    public createdRole($byte: ByteArray): void {
        
        var roleInfo: s2c_after_create_role = new s2c_after_create_role();
                ...
                SDKUTIL.CreateRole(
                    {
                        ...
                        servername: roleInfo.serverId,// 服务器名称
                        roleid: roleInfo.guid,// 角色id
    ...
    public getHanderMap(): Object {
        ...
        obj[Protocols.SMSG_AFTER_CREATE_ROLE] = ($byte: ByteArray) => { this.createdRole($byte) };
        return obj;
    }
