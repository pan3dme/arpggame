class InstanceData extends GuidObject {
    ...
    public onBaseCreated(): void {
        ...
        this.AddListen(SharedDef.INSTANCE_INT_FIELD_ACTIVE, ($binlog: any) => {
        ...
        this.AddListen(SharedDef.INSTANCE_INT_FIELD_GROUP_EXP_TIMES, ($binlog: any) => {
    ...
    public getInstanceIntFieldResSatrt(): Array<any> {
        ...
        for (var i: number = SharedDef.INSTANCE_INT_FIELD_RES_START; i < SharedDef.INSTANCE_INT_FIELD_RES_END; i++)//FIXME
        {
            ...
            var passed: number = this.GetByte(idx, 1);
            var recive: number = this.GetByte(idx, 2);
    ...
    //3v3每日奖励领取
    public get3V3DayRewardState(id: number): boolean {
     ...
     * 通关宝箱领取情况
     */
    private _passboxreceiveary: Array<boolean>
    public getOpenPassBoxReceiveAry(): Array<boolean> {
    ...
    private refreshBoxReceive(): Array<boolean> {
        var aa: Array<boolean> = new Array;
