...
var faction;
(function (faction) {
    var LeagueLs = /** @class */ (function (_super) {
        __extends(LeagueLs, _super);
        function LeagueLs() {
        ...
        LeagueLs.prototype.dispose = function () {
        ...
        LeagueLs.prototype.applyLoad = function () {
            var _this = this;
        ...
        LeagueLs.prototype.loadConfigCom = function () {
        ...
        LeagueLs.prototype.resize = function () {
            _super.prototype.resize.call(this);
        };
        LeagueLs.prototype.onDown = function ($e) {
        ...
        LeagueLs.prototype.onMove = function ($e) {
        ...
        LeagueLs.prototype.onUp = function ($e) {
        ...
        LeagueLs.prototype.butClik = function (evt) {
            if (evt.target == this.c_close) {
                this.hide();
            }
        };
        LeagueLs.prototype.show = function () {
            UIManager.getInstance().addUIContainer(this);
            //请求数据
            this.resetData();
        };
        LeagueLs.prototype.hide = function () {
            UIManager.getInstance().removeUIContainer(this);
        };
        LeagueLs.prototype.resetData = function () {
            var _this = this;
            LoadManager.getInstance().load(Scene_data.fileRoot + "txt/league_ls.txt", LoadManager.XML_TYPE, function ($str) {
                $str = $str.replace(/\r/g, "");
                //notepad++默认一个回车键入\n\r ,所以默认将所有的\r隐藏
    ...
    faction.LeagueLs = LeagueLs;
})(faction || (faction = {}));
//# sourceMappingURL=LeagueLs.js.map