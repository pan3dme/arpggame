...
class AreaType {
    ...
    public static expfuben_21: number = 21;
    ...
    public static fubenFactionLeftPane_28: number = 28;  //副本左边任务
    public static fubenBossLeftPane_29: number = 29;  //副本左边任务
...
class MergeServerMsgVo {
    ...
    public getLocalData(): any {
        ...
        var idx: number = $indexUrl.lastIndexOf("/");
        var r: string = $indexUrl.slice(0, idx);
        var objStr: string = localStorage.getItem(r);
        var sesStr: string = sessionStorage.getItem(r);
        if (sesStr) {
...
class GameData {
    ...
    public static sdk: number;//0 5wan;1 g2
    /*
    *$typeId  模块面板ID
    *data:属性显示
    */
