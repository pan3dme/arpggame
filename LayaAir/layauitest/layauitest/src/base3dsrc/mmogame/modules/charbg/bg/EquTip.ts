...
class EquTip extends BaseTip {
    ...
    public refreshLevTypeZL(): void {
        ...
        var daoName: any = TableData.getInstance().getData(TableData.tb_realmbreak_base, this._entryData.realmbreak_level);
        var daoColor: string = GuidData.player.getStateLev() >= daoName.id ? ColorType.colorffecc6 : ColorType.Redd92200;
