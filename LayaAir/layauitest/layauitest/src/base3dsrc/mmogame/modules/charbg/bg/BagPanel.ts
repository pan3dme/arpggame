module charbg {
    ...
    export class BagPanel extends UIConatiner {
        ...
        public show(): void {
            ...
            //整理刷新时间
            this.refreshTime();
            var setime: number = this.getserveTime();
            if (setime < this.nextTime) {
                var num: number = TableData.getInstance().getData(TableData.tb_item_sort_cd, 1)["cd"];
        ...
        private b_zhenglitxt: UICompenent;
        ...
        private update(t): void {
            ...
            var currentnum: number = this.nextTime - setime;
