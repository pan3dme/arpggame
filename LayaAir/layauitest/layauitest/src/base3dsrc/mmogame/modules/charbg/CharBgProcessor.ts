module charbg {
    export class CharBgEvent extends BaseEvent {
        ...
        public static REFRESH_TIME_CHAR_BG_PANEL: string = "REFRESH_TIME_CHAR_BG_PANEL"; //显示面板
        ...
        public static HIDE_ALL_TIP_EVENT: string = "HIDE_ALL_TIP_EVENT";
