module selectserver {
    ...
    export class Ssgonggao extends UIVirtualContainer {
        ...
        public resetData(): void {
            LoadManager.getInstance().load(Scene_data.fileRoot +"txt/gg.txt", LoadManager.XML_TYPE, ($str: string) => {
                $str = $str.replace(/\r/g, "\n");
                var aaa = LabelTextFont.writeTextLabel(this._baseRender.uiAtlas, this.b_gonggao.skinName, $str, 16,TextAlign.LEFT,685, ColorType.color9a683f);
