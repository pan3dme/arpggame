module divinesword {
    ...
    export class TaskCell {
        ...
        public data: training.TaskVo
        public parent: DivineswordTask

        public setVo($vo: training.TaskVo, $indx: number) {
            this.data = $vo;
        ...
        public click(evt: InteractiveEvent): void {
            var vo: training.TaskVo = this.data
    ...
    export class DivineswordTask extends UIVirtualContainer {
        ...
        private _itemAry: Array<training.TaskVo>
        public show(): void {
