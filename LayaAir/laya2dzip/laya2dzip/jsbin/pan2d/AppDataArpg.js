...
(function (pan2d) {
    var AppDataArpg = /** @class */ (function () {
        ...
        AppDataArpg.math3dto2Darpg = function ($p) {
            ...
            var fovw = Scene_data.stageWidth / 4 / pan2d.Override2dEngine.htmlScale;
            var fovh = Scene_data.stageHeight / 4 / pan2d.Override2dEngine.htmlScale;
        ...
        AppDataArpg.resetSelfPosCenter = function () {
            if (GameInstance.mainChar) {
                ...
                var $tw = Scene_data.stageWidth / 4 / pan2d.Override2dEngine.htmlScale;
                var $th = Scene_data.stageHeight / 4 / pan2d.Override2dEngine.htmlScale;
