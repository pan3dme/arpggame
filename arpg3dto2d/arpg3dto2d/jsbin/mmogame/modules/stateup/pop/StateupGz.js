...
var stateup;
(function (stateup) {
    var StateupGz = /** @class */ (function (_super) {
        __extends(StateupGz, _super);
        function StateupGz() {
        ...
        StateupGz.prototype.dispose = function () {
        ...
        StateupGz.prototype.applyLoad = function () {
            var _this = this;
        ...
        StateupGz.prototype.loadConfigCom = function () {
        ...
        StateupGz.prototype.resize = function () {
            _super.prototype.resize.call(this);
        };
        StateupGz.prototype.onDown = function ($e) {
        ...
        StateupGz.prototype.onMove = function ($e) {
        ...
        StateupGz.prototype.onUp = function ($e) {
        ...
        StateupGz.prototype.butClik = function (evt) {
            if (evt.target == this.c_close) {
                this.hide();
            }
        };
        StateupGz.prototype.show = function () {
            UIManager.getInstance().addUIContainer(this);
            //请求数据
            this.resetData();
        };
        StateupGz.prototype.hide = function () {
            UIManager.getInstance().removeUIContainer(this);
        };
        StateupGz.prototype.resetData = function () {
            var _this = this;
            LoadManager.getInstance().load(Scene_data.fileRoot + "txt/jingjie_sm.txt", LoadManager.XML_TYPE, function ($str) {
                $str = $str.replace(/\r/g, "");
                //notepad++默认一个回车键入\n\r ,所以默认将所有的\r隐藏
    ...
    stateup.StateupGz = StateupGz;
})(stateup || (stateup = {}));
//# sourceMappingURL=StateupGz.js.map