...
module tb {
    ...
    export class TB_item_template {
        ...
        public realmbreak_level:number;
    ...
    export class TB_world_map {
        ...
        public y: number;
        public info: string;
        public minmapinfo: Array<number>
    ...
    export class TB_faction_match_base {
        public born_2: Array<number>
        public born_1: Array<number>
        public flag_pos: Array<number>
        public constructor($obj: any) {
            if (!$obj) {
                traceNoTabelData();
            }
        ...
        public static getItem(): Array<TB_faction_match_base> {
            var $arr: Array<TB_faction_match_base> = new Array
            var $obj: any = TableData.getInstance().getTableByName(TableData.tb_faction_match_base)
            for (var $key in $obj.data) {
                var $vo: TB_faction_match_base = new TB_faction_match_base($obj.data[$key])
                $arr.push($vo)
            }
            return $arr
        }
        public static getTempVo($id): TB_faction_match_base {
            var $obj: any = TableData.getInstance().getData(TableData.tb_faction_match_base, $id)
            var $vo: TB_faction_match_base = new TB_faction_match_base($obj)
            return $vo
        }
    }
    ...
    */
    ...
    export class TB_map {
        ...
        public minimapinfo: Array<number>
        public show: Array<number>
        public path: Array<Array<any>>
        public block: Array<Array<any>>
        public teleportmap: Array<Array<any>>
        ...
        public getTeleportmap($toId: number): Vector2D {
            for (var i: number = 0; i < this.teleportmap.length; i++) {
    ...
    export class TB_shop_chongzhi {
        ...
        public rate: number
        public non_first_extra_gold: number
    ...
    export class TB_welfare_checkin {
        public id: number;
        public item: Array<Array<number>>
        public getback_cost: Array<Array<number>>
        public vip: number;
        public times: number;
    ...
    export class TB_equipdevelop_refine {
        ...
        public fail_to_star: number;
        public advance_chance: number;
        public props: Array<Array<number>>;
        public props0: Array<Array<number>>;
        public props1: Array<Array<number>>;
        public props2: Array<Array<number>>;
        ...
        public cost: Array<Array<number>>;
        public advance_cost: Array<Array<number>>;
        public advance_by_money: Array<Array<number>>;
    ...
    export class TB_group_type {
        public id: number;
        public sort: number;
        public lv: number;
        public name: string;
        public min_lev:Array<number>
        public max_lev:Array<number>
        ...
        public static get_TB_group_typeById($id: number): TB_group_type {
            var $obj: any = TableData.getInstance().getData(TableData.tb_group_type, $id);
            var $vo: TB_group_type = new TB_group_type($obj)
            return $vo
        }

        public static get_TB_group_type(): Array<TB_group_type> {
            var $arr: Array<TB_group_type> = new Array
            var $obj: any = TableData.getInstance().getTableByName(TableData.tb_group_type);
            // //console.log("基本数据", $obj)
            for (var $key in $obj.data) {
                var $vo: TB_group_type = new TB_group_type($obj.data[$key])
                $arr.push($vo)
            }
            return $arr
        }
    ...
    export class TB_recharge_7day_extra_reward {
        public id: number;
        public day: number;
        public reward: Array<Array<number>>;
        ...
        public static get_TB_recharge_7day_extra_rewardById($id: number): TB_recharge_7day_extra_reward {
            var $obj: any = TableData.getInstance().getData(TableData.tb_recharge_7day_extra_reward, $id);
            var $vo: TB_recharge_7day_extra_reward = new TB_recharge_7day_extra_reward($obj)
            return $vo
        }

        public static get_TB_quest_adventure_base(): Array<TB_recharge_7day_extra_reward> {
            var $arr: Array<TB_recharge_7day_extra_reward> = new Array
            var $obj: any = TableData.getInstance().getTableByName(TableData.tb_recharge_7day_extra_reward);
            // //console.log("基本数据", $obj)
            for (var $key in $obj.data) {
                var $vo: TB_recharge_7day_extra_reward = new TB_recharge_7day_extra_reward($obj.data[$key])
                $arr.push($vo)
            }
            return $arr
        }
...
class TableData {
    ...
    public static tb_local3v3_daily_reward: string = "tb_local3v3_daily_reward";
    ...
    public static tb_faction_match_champion:string = "tb_faction_match_champion";
    ...
    public static tb_buff_base: string = "tb_buff_base";
    ...
    public static tb_instance_stage_chapter: string = "tb_instance_stage_chapter";
    public static tb_instance_stage: string = "tb_instance_stage";
    public static tb_instance_stage_bonus: string = "tb_instance_stage_bonus";
    public static tb_instance_stage_base: string = "tb_instance_stage_base";
    public static tb_instance_stage_auto: string = "tb_instance_stage_auto";
    public static tb_instance_group_exp: string = "tb_instance_group_exp";
    
    public static tb_faction_match_phase: string = "tb_faction_match_phase";
    public static tb_faction_match_base: string = "tb_faction_match_base";
    public static tb_faction_match_winstrike: string = "tb_faction_match_winstrike";
    public static tb_offline_exp_base: string = "tb_offline_exp_base";
    public static tb_talisman_slot: string = "tb_talisman_slot";
    public static tb_group_type: string = "tb_group_type";
    public static tb_group_exp: string = "tb_group_exp";
    public static tb_item_sort_cd: string = "tb_item_sort_cd";
    public static tb_vip_uplev: string = "tb_vip_uplev";
    public static tb_recharge_7day_extra_reward: string = "tb_recharge_7day_extra_reward";
    public static tb_recharge_7day_reward: string = "tb_recharge_7day_reward";
    public static tb_recharge_first_reward: string = "tb_recharge_first_reward";
    public static tb_refill_main_poppanel_level: string = "tb_refill_main_poppanel_level";

    public static tb_recharge_wheel:string = "tb_recharge_wheel";
