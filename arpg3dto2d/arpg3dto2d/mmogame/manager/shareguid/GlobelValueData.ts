class GlobelValueData extends GuidObject {
    ...
    public onBaseCreated(): void {
        ...
        //家族联赛阶段变化监听
        this.AddListen(SharedDef.GLOBALVALUE_INT_FIELD_FACTION_MATCH_CURRENT_PHASE, ($binlog: any) => {
        ...
        //家族联赛第几届变化监听
        this.AddListen(SharedDef.GLOBALVALUE_INT_FIELD_FACTION_MATCH_GAMES, ($binlog: any) => {
    ...
    public getFactionHonorLS():number{
