module charbg {
    export class VipPanel extends WindowMinUi {
        ...
        public drawBaseVip(): void {
            ...
            var nextVipData: any = TableData.getInstance().getData(TableData.tb_vip_base, nextVipLev);
        ...
        private czClick($e: InteractiveEvent): void {
