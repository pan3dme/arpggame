module treasure {
    ...
    export class TreasureRightPanel extends UIVirtualContainer {
        ...
        public resetData($data: TreasureItemVo): void {
            ...
            this._itdata = $data;
            //设置模型
            var $uiPanel: TreasurePage = <TreasurePage>this.parent;
            ...
            if (resitem1 == null) {
                ...
                (<FrameCompenent>this.btnuiary[6]).goToAndStop($data.state == 1 ? 0 : 1);
            ...
            var $uplevelobj: any = TableData.getInstance().getData(TableData.tb_skill_uplevel, skilltab.uplevel_id[0])
        ...
        private drawIcon(): void {
            ...
            IconManager.getInstance().getIcon($url + "_c.png",
                ($img: any) => {
                    ...
                    var equ: UIRectangle = this.parentTarget.baseAtlas.getRec("equ" + $vo.tabvo.quality)
