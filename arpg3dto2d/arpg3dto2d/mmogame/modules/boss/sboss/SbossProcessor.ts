module sboss {
    ...
    export class SbossEvent extends BaseEvent {
        ...
        public static SHOW_BOSSINFO_EVENT: string = "SHOW_BOSSINFO_EVENT";
    ...
    export class SbossProcessor extends BaseProcessor {
        ...
        private showbossinfo($data:tb.TB_mass_boss_info): void {
            if (!this.bossInfoPanel) {
                this.bossInfoPanel = new BossInfoPanel();
            }
            this.bossInfoPanel.load(() => {
                //停止绘制前面的ui
                this.bossInfoPanel.show($data);
            })
        }

        private bossGz:BossGz;
        private showgz(): void {
            if (!this.bossGz) {
                this.bossGz = new BossGz();
            }
            this.bossGz.load(() => {
                //停止绘制前面的ui
                this.bossGz.show();
