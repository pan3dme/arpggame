...
class PlayerGuidObject extends GuidObject {
    ...
    private testping_pong(): void {
        TimeUtil.addTimeTick(5000, () => { NetManager.getInstance().protocolos.ping_pong() })
    ...
    public onBaseCreated(): void {
        ...
        this.AddListen(SharedDef.PLAYER_INT_FIELD_ADVENTURE_SKILL_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        this.AddListen(SharedDef.PLAYER_FIELD_EQUIPDEVELOP_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        this.AddListen(SharedDef.PLAYER_FILED_EQUIP_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        this.AddListen(SharedDef.PLAYER_INT_FIELD_WINGS_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        this.AddListen(SharedDef.PLAYER_INT_FIELD_REALMBREAK_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        this.AddListen(SharedDef.PLAYER_FIELD_SKILL_FORCE, ($binlog: any) => {
            ModuleEventManager.dispatchEvent(new stronger.StrongerEvent(stronger.StrongerEvent.CHG_Stronger_EVENT));
        });
        ...
        this.AddListen(SharedDef.PLAYER_INT_FIELD_OFFLINE_MINUTES, ($binlog: BinLogStru) => {
            ModuleEventManager.dispatchEvent(new activity.ActivityEvent(activity.ActivityEvent.ACTIVITY_REFRESHTIME_EVENT));
        })
        this.AddListen(SharedDef.PLAYER_INT_FIELD_AUTO_GROUP_MATCH, ($binlog: BinLogStru) => {
            ModuleEventManager.dispatchEvent(new team.TeamEvent(team.TeamEvent.AUTOMATCH_TEAM_PANEL));
        })
        this.AddListen(SharedDef.PLAYER_INT_FIELD_BAG_SORT_TIME, ($binlog: BinLogStru) => {
            ModuleEventManager.dispatchEvent(new charbg.CharBgEvent(charbg.CharBgEvent.SHOW_CHAR_BG_PANEL));
        })
        this.AddListen(SharedDef.PLAYER_INT_FIELD_SHOP_CHARGE_FLAG, ($binlog: BinLogStru) => {
            ModuleEventManager.dispatchEvent(new store.StoreEvent(store.StoreEvent.RECHARGE_CHG_EVENT));
        })
        ...
        this.AddListen(SharedDef.PLAYER_INT_FIELD_RECHARGE_LOTTERY_TIMES, ($binlog: BinLogStru) => {
    ...
    /**神剑战力 */
    public getAdventureForce(): number {
