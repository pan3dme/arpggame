module msgtip {
    export class MsgTipEvent extends BaseEvent {
        ...
        public static REFRISH_SYS_AND_UI_CHANGE = "REFRISH_SYS_AND_UI_CHANGE";
    ...
    export class MsgTipProcessor extends BaseProcessor {
        ...
        private _systemOpenShow: SystemOpenShow
            ...
            if (GuidData.map && SceneManager.getInstance().render) {
                ...
                if ($tb.showmodel) {
                    if (!this._systemOpenShow) {
                        this._systemOpenShow = new SystemOpenShow();
                    }
                    this._systemOpenShow.load(() => {
                        UIManager.getInstance().addUIContainer(this._systemOpenShow);
                        this._systemOpenShow.setModelByID($tb)
